...
MAYA_PUBLIC_KEY=config('MAYA_PUBLIC_KEY')
MAYA_SECRET_KEY=config('MAYA_SECRET_KEY')
MAYA_API_URL=config('MAYA_API_URL')
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'eac2-103-186-120-4.ngrok-free.app','13.213.131.66']