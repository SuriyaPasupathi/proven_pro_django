...
class Users(AbstractUser):
    ...
    gov_id_status = models.CharField(max_length=20, choices=[('pending', 'Pending'), ('approved', 'Approved'), ('rejected', 'Rejected')], default='pending')

    address_document = models.FileField(upload_to='address/', storage=VerificationDocStorage, null=True, blank=True)
    address_status = models.CharField(max_length=20, choices=[('pending', 'Pending'), ('approved', 'Approved'), ('rejected', 'Rejected')], default='pending')
